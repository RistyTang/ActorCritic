...
class LinUCB:
    ...
    def update(self, chosen_arm, reward, context):
        ...
        self.A[chosen_arm] += np.outer(context, context.T)
        self.b[chosen_arm] += reward * context.flatten()
...
def get_now_reward(curr_metrics):
    ...
    '''
    context = [1.0 for _ in range(18)]      # tqy:为什么是1*d 应当是d * 1
    # context = np.ones((18,1))
